...
public class MoreIfStatements {
	...
	public static void main(String[] args) {
		...
		if (day.equals("Saturday")) {
			System.out.println("I am having Java class today."); //we can have multiple statements like shown below
			System.out.println("I am very excited.");
			System.out.println("I am going to have fun with my classmates.");
		}else {
			System.out.println("I don't know which class I have today.");
